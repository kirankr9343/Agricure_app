...
import { Loader2, Bell, MessageSquare, Phone, Mail } from "lucide-react";
  ...
  return (
    <Card className="w-full bg-card/90 backdrop-blur-sm">
      <CardHeader className="items-center text-center">
        ...
        <CardDescription>
          Choose how and when you receive information.
        </CardDescription>
      </CardHeader>
      <form onSubmit={handleSubmit}>
        <CardContent className="space-y-6">
          ...
          <Button type="submit" className="w-full !mt-8" disabled={isLoading || communicationModes.length === 0 || !updateFrequency}>
